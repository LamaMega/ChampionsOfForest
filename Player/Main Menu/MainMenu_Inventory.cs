...
namespace ChampionsOfForest
{
	public partial class MainMenu : MonoBehaviour
	{
		...
		private void DrawInventory()
		{
			...
			GUI.Box(SlotsRect, Translations.MainMenu_Inventory_1/*Inventory*/, new GUIStyle(GUI.skin.box) { font = secondaryFont, fontSize = Mathf.RoundToInt(65 * screenScale) });      //tr
			SelectedItem = -1;
			...
			try
			{
				...
				GUI.Box(eq, Translations.MainMenu_Inventory_2/*Equipment*/, new GUIStyle(GUI.skin.box) { font = secondaryFont, fontSize = Mathf.RoundToInt(65 * screenScale) });     //tr
				...
				DrawInvSlot(head, -2, Translations.MainMenu_Inventory_3/*Head*/);				  //tr
				DrawInvSlot(chest, -3, Translations.MainMenu_Inventory_4/*Torso*/);		   	  //tr
				DrawInvSlot(pants, -4, Translations.MainMenu_Inventory_5/*Legs*/);			   	  //tr
				DrawInvSlot(boots, -5, Translations.MainMenu_Inventory_6/*Feet*/);			   	  //tr
				DrawInvSlot(shoulders, -6, Translations.MainMenu_Inventory_7/*Shoulders*/);   	  //tr
				DrawInvSlot(gloves, -7, Translations.MainMenu_Inventory_8/*Hands*/);		   	  //tr
				DrawInvSlot(tallisman, -8, Translations.MainMenu_Inventory_9/*Neck*/);		   	  //tr
				DrawInvSlot(bracer, -9, Translations.MainMenu_Inventory_10/*Wrists*/);		   	  //tr
				DrawInvSlot(ringR, -10, Translations.MainMenu_Inventory_11/*Finger*/);		   	  //tr
				DrawInvSlot(ringL, -11, Translations.MainMenu_Inventory_11/*Finger*/);		   	  //tr
				DrawInvSlot(weapon, -12, Translations.MainMenu_Inventory_12/*Main hand*/);	   	  //tr
				DrawInvSlot(offhand, -13, Translations.MainMenu_Inventory_13/*Offhand*/);         //tr
		...
		private void DrawItemInfo(Vector2 pos, Item item, bool drawCompare = false, Item comparedItem = null)
		{
			...
			{
				GUI.Label(LevelAndTypeRect, Translations.MainMenu_Inventory_16/*Level*/ + " " + item.level, LevelStyle);	//tr
			}
			//else
			//{
			//	GUI.color = Color.red;
		...
		private void DrawInvContextMenu()
		{
			if (itemContextMenu.HasValue)
			{
				...
				{
					if (DrawInvContextMenuBtn(x, y, buttonHeight, w, Translations.MainMenu_Inventory_17/*Consume*/))	//tr
					{
				...
				{
					if (DrawInvContextMenuBtn(x, y, buttonHeight, w, Translations.MainMenu_Inventory_18/*Split Stack*/))	//tr
					{
				...
				{
					if (DrawInvContextMenuBtn(x, y, buttonHeight, w, Translations.MainMenu_Inventory_19/*Drop*/))	//tr
					{
		...
		private void DrawCharacterSummary()
		{
			...
			GUI.Box(statsRect, Translations.MainMenu_Inventory_25/*Summary*/, new GUIStyle(GUI.skin.box) { font = secondaryFont, fontSize = Mathf.RoundToInt(65 * screenScale) }); //tr
			...
			GUI.Label(new Rect(statsRect.x, y, 300 * screenScale, 25 * screenScale), Translations.MainMenu_Inventory_20/*Melee Damage*/, TitleStyle);	//tr
			y += 25 * screenScale;
			...
			y += 75 * screenScale;
			GUI.Label(new Rect(statsRect.x, y, 300 * screenScale, 25 * screenScale), Translations.MainMenu_Inventory_21/*Ranged Damage*/, TitleStyle);	//tr
			y += 25 * screenScale;
			...
			y += 75 * screenScale;
			GUI.Label(new Rect(statsRect.x, y, 300 * screenScale, 25 * screenScale), Translations.MainMenu_Inventory_22/*Magic Damage*/, TitleStyle);	//tr
			y += 25 * screenScale;
			...
			y += 75 * screenScale;
			GUI.Label(new Rect(statsRect.x, y, 300 * screenScale, 25 * screenScale), Translations.MainMenu_Inventory_23/*Toughness*/, TitleStyle);	//tr
			y += 25 * screenScale;
