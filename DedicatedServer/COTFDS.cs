		...
		public static void ReadDediServerConfig()
		{
			...
			else
			{
				string[] DefaultConfig = new string[]
				{
					...
					"-For difficulty, please write a number from 0 to 10. (0-Normal, 1-Hard, 2-Elite, 3-Master, 4-Challenge1, 5-Challenge2, 6-Challenge3, 7-Challenge4, 8-Challenge5, 9-Challenge6, 10-Hell)",
